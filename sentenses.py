...
def get_adverb():
    ...
    adverbs = ["quickly","slowly","Angrily","fastly","softly","beautifuly","greedily"]
...
def make_sentence(quantity, tense):
    ...
    prepositional_noun = get_noun(quantity)  # Use the same quantity for prepositional noun
    adverb = get_adverb() # Use to get the adverb
